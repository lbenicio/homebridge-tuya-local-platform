...
hero:
  ...
  actions:
    ...
    - theme: alt
      text: GitHub
      link: https://github.com/nubisco/homebridge-tuya-local-platform
  image:
    src: /logo.svg
    alt: Homebridge Tuya Local Platform

features:
  - icon:
      src: /homebridge.svg
    title: Homebridge Native
    details: Seamless Apple HomeKit integration via Homebridge with full accessory lifecycle management and Config UI X support.
  - icon:
      src: /privacy.svg
    title: 100% Local LAN
